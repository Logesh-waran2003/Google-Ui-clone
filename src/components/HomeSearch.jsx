...
export default function HomeSearch() {
  ...
  return (
    <>
      ...
      {emptySearch ? (
        <p className="text-red-600 justify-center flex mt-1">
          Please enter someting to search{" "}
        </p>
      ) : null}
      <div className="flex flex-col space-y-2 sm:space-y-0 justify-center items-center sm:flex-row mt-8 sm:space-x-4">
        <button
